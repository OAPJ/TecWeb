...
// crear cadena para quwery

//ejecutar wuery insersion
//crear otra query alv alv alv avl alv alvalvlalvalvlalv alv alv alvavl alv lavlalva vlavavla vlav alv alva vlalvalv alvlav
$QueryConsulta= "SELECT * FROM aspirante";
//ejecutar query consulta = tbla
...
<html>
    <head>
        <title>Formulario  HTMP - JS - PHP- MySQL pag 5</title>
    </head>
    <meta charset="utf-8">
